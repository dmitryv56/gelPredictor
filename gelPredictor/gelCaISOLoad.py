...
"""       Short-Term and Very Short-Term forecasting for renewable electricity loading for https:\\GridStatus.io - data
g(reen)e(lectricity)l(oading)Ca(lifornia)ISOL(aod) - gelCaISOLoad
...
from src.flow_control import cntrPath_for_CaISOPred
